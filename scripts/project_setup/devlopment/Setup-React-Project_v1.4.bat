...
call :create_file "%ROOT%\pages\%1\%2\components\%2Component.js" "%2 Component"
call :create_file "%ROOT%\pages\%1\%2\sections\%2HeroSection.js" "%2 Hero Section"
call :create_file "%ROOT%\pages\%1\%2\sections\%2FeaturesSection.js" "%2 Features Section"
exit /b
